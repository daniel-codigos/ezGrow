...
export default function TabOneScreen() {
  ...
  const handleButtonPress = (btntxt) => {
    ...
    console.log(espacioName)
    navigation.navigate('pages/aire/'+btntxt, { espacioName: espacioName });
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.cont_prin}>
        <TouchableOpacity onPress={(e) => handleButtonPress("fan_power")} style={styles.button}>
          <Icon2 name="fan" size={30} color="#ffffff" />
        </TouchableOpacity>
        <TouchableOpacity onPress={(e) => handleButtonPress("fan_config")} style={styles.button}>
