  ...
  return (
    <View style={styles.container}>
      <View style={styles.cont_prin}>
        <TouchableOpacity onPress={(e) => handleButtonPress("RiegoApp")} style={styles.button}>
        <Icon2 name="hand-holding-water" size={35} color="#ffffff" />
        </TouchableOpacity>
        <TouchableOpacity onPress={(e) => handleButtonPress("RiegoConfig")} style={styles.button}>
